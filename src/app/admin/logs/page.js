        ...
        <div className="space-y-10">
            ...
            <div className="flex flex-col gap-6 p-8 glass-card border-white/5 bg-white/[0.02]">
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex gap-2 flex-wrap">
                        {['all', 'Leader', 'captain', 'faculty', 'core', 'member'].map(role => (
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex-grow">
                                        ...
                                        <div className="flex items-center gap-4 text-[10px] font-black uppercase tracking-widest text-white/30">
                                            ...
                                            <span className={`flex items-center gap-1.5 px-2 py-1 rounded-md border ${['Leader', 'captain'].includes(log.profiles?.role) ? 'border-brand-cyan/30 text-brand-cyan bg-brand-cyan/5' : 'border-white/10'}`}>
