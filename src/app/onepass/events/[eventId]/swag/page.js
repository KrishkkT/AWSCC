                ...
                >
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full bg-[#0C111D] border border-[#1a2540] rounded-xl pl-10 pr-4 py-2.5 text-xs text-white placeholder-slate-500 font-mono outline-none focus:border-emerald-500"
                        />
                    </div>
                    <button
                        type="submit"
                        disabled={!manualCode.trim() || claiming || !currentResource}
                        className="px-5 py-2.5 bg-[#1a2540] hover:bg-emerald-500 hover:text-black disabled:opacity-50 text-white rounded-xl text-xs font-semibold font-mono"
                    >
                        Claim
                    </button>
                </form>
                    ...
                    <div className="max-w-md mx-auto p-2 bg-[#0C111D] border border-[#1a2540] rounded-2xl space-y-1 max-h-56 overflow-y-auto text-left">
                        {searchResults.map((att) => (
                            ...
                            >
                                ...
                                <span className="text-[10px] font-mono font-bold text-emerald-400">{att.check_in_status}</span>
                            </button>
                        ))}
                    </div>
                )}
